...
function GM:CreateMainMenu()
	...
	gw_loadout_selection.Paint = function()
		draw.RoundedBoxEx(8, 2, 2, gmw - 4, 60, Color(205, 201, 201, 225), false, false, false, false)
		
		gw_drawimage(mats[2], Color(255, 255, 255), 15, 10, 48, 48)
		gw_drawimage(mats[2], Color(255, 255, 255), gw_loadout_selection:GetWide() - 63, 10, 48, 48)
		
		draw.SimpleText("Loadout", "HUDText_Rage", gw_loadout_selection:GetWide() / 2, 25, Color(255, 255, 255), TEXT_ALIGN_CENTER)
	end
	...
	gw_inventory_selection.Paint = function()
		draw.RoundedBoxEx(8, 2, 2, gmw - 4, 60, Color(160, 82, 45, 225), false, false, true, true)
		
		gw_drawimage(mats[4], Color(255, 255, 255), 15, 10, 48, 48)
		gw_drawimage(mats[4], Color(255, 255, 255), gw_inventory_selection:GetWide() - 63, 10, 48, 48)
		
		draw.SimpleText("Inventory Selection", "HUDText_Rage", gw_inventory_selection:GetWide() / 2, 25, Color(255, 255, 255), TEXT_ALIGN_CENTER)
	end
end